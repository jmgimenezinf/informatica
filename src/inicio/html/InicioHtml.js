...
function InicioHtml() {
 var html= <section>
    ...
    <p>La gestión de las carreras incluye no solamente la <a href="/index.php/docentes">docencia</a>, sino también las actividades de <a href="/index.php/investigacion">investigación</a> y de <a href="/index.php/extension">extensión</a>, que fortalecen la vinculación con la sociedad.</p>
