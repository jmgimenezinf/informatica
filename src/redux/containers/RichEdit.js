...
import { addRichEdit } from '../actions';
...
class RichEdit extends React.Component {
    ...
    render() {
        ...
        <div className="RichEditor-root" onClick={this.clickButton(contentState)}>
            <BlockStyleControls
    ...
    const mapStateToProps = (state) => ({
        richEdit: state.richEdit.richEdit
      });
      
RichEdit = connect(mapStateToProps)(RichEdit)
